...
# %autoreload 3
import torch
from video_model_rope import DiTModelWrapper
...
class MNISTFactory(AbstractTrainerFactory):
    ...
    def make_optimizer(self, model):
        ...
        # use the default hparameters except learning rate is doubled
        return SOAP(model.parameters(), lr = 2e-4, betas=(.9, .999), weight_decay=0, precondition_frequency=10)
